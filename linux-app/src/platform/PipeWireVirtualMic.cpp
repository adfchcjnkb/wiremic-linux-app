...
PipeWireVirtualMic::PipeWireVirtualMic(VirtualMicConfig config)
...
bool PipeWireVirtualMic::start() {
  ...
  struct pw_properties* props = pw_properties_new(
      ...
      PW_KEY_MEDIA_CLASS, "Audio/Source", PW_KEY_MEDIA_ROLE, "Communication",
      PW_KEY_NODE_NAME, config_.nodeName.c_str(), PW_KEY_NODE_DESCRIPTION,
      config_.nodeDescription.c_str(), PW_KEY_NODE_LATENCY, "480/48000",
      nullptr);
